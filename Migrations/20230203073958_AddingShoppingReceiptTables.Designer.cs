...
namespace BasheerCinamanApi.Migrations
{
    ...
    [Migration("20230203073958_AddingShoppingReceiptTables")]
    partial class AddingShoppingReceiptTables
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BasheerCinamanApi.Models.ShoppingReceipt", b =>
                {
                    b.Property<Guid>("ShoppingCartId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTime>("DateOfReciept")
                        .HasColumnType("datetime2");

                    b.Property<double>("RecieptTotalAmount")
                        .HasColumnType("float");
                    ...
                    b.ToTable("ShoppingRecieptTable");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "L98RUEWVVEA91PDK1NO3",
                            Name = "SuperAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "GMDQ7IR7YRD48CLGJ7WY",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "HCUNHF9MTUBSLQCKT122",
                            Name = "Dev",
                            NormalizedName = "DEV"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "78H168IHFKNB3TY0FR64",
                            Name = "DataEntry",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6edd1642-66ef-440b-a1bb-0119ee5bb800",
                            Email = "BasheerSuper@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "BASHEERSUPER@GMAIL.COM",
                            NormalizedUserName = "BASHEERSUPER@GMAIL.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEAsAsU6DrLyOPSPyZFtn9SnSmpbQfF6oozjie91HDjB4g+HQhcgqgv/qfvzBYvTvYw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "X8YXM4XB2P3H0329ZX6A",
            ...
            modelBuilder.Entity("BasheerCinamanApi.Models.ShoppingCartModel", b =>
                {
                    ...
                    b.HasOne("BasheerCinamanApi.Models.ShoppingReceipt", "ShoppingReceiptsTable")
                        .WithMany()
                    ...
                    b.Navigation("ShoppingReceiptsTable");
                });

            modelBuilder.Entity("BasheerCinamanApi.Models.ShoppingReceipt", b =>
                {
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "IdentityUserTable")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("IdentityUserTable");
                });
